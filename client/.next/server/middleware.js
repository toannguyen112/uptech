...
/* harmony import */ var next_dist_server_web_adapter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(384);
        ...
        var mod = __webpack_require__(330)
...
function middleware(req) {
    ...
    if (req.nextUrl.pathname.startsWith("/admin/")) {
        if (hasToken) {
            ...
            return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.rewrite(new URL("/admin/login", req.url));
        }
    }
}
...
/******/ var __webpack_exports__ = (__webpack_exec__(479));
